...
export function HistoryIcon({ className }: { className?: string }) {
  return (
    ...
    >
      ...
      <path d="M8 2v4" />
      <path d="M16 2v4" />
      <rect x="6" y="12" width="3" height="3" fill="currentColor" stroke="none" />
      <rect x="10.5" y="12" width="3" height="3" fill="currentColor" stroke="none" />
      <rect x="6" y="16.5" width="3" height="3" fill="currentColor" stroke="none" />
    </svg>
  );
}
...
export function GoogleIcon({ className }: { className?: string }) {
  return (
    <svg viewBox="0 0 24 24" width={20} height={20} className={className} aria-hidden="true">
      ...
      <path
        fill="#34A853"
        d="M12 24c3.24 0 5.96-1.07 7.95-2.91l-3.88-3a7.2 7.2 0 0 1-10.71-3.78H1.36v3.09A12 12 0 0 0 12 24Z"
      />
      <path fill="#FBBC05" d="M5.36 14.31a7.2 7.2 0 0 1 0-4.62V6.6H1.36a12 12 0 0 0 0 10.8l4-3.09Z" />
      <path
        fill="#EA4335"
        d="M12 4.77c1.76 0 3.34.61 4.58 1.8l3.44-3.44C17.95 1.19 15.24 0 12 0A12 12 0 0 0 1.36 6.6l4 3.09A7.15 7.15 0 0 1 12 4.77Z"
      />
    </svg>
  );
}
...
export function EyeSlashIcon({ className }: { className?: string }) {
  return (
    <svg
      ...
      aria-hidden="true"
    >
      <path d="M17.94 17.94A10.9 10.9 0 0 1 12 20c-7 0-11-8-11-8a19.7 19.7 0 0 1 5.06-5.94M9.9 4.24A10.8 10.8 0 0 1 12 4c7 0 11 8 11 8a19.7 19.7 0 0 1-2.16 3.19m-6.72-1.07a3 3 0 1 1-4.24-4.24" />
      <path d="M1 1l22 22" />
    </svg>
  );
}
