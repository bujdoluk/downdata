...
const PUBLIC_EXACT = new Set([
  ...
  "/api/catalog",
  // Generated by src/app/robots.ts. Without this, crawlers requesting
  // /robots.txt hit this same gate and get redirected to /login instead
  // of the actual rules — silently defeating the whole file. The
  // matcher below has no built-in exemption for it.
  "/robots.txt",
]);
