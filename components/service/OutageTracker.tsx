...
export default function OutageTracker({ incidents, timeZone }: { incidents: StatuspageIncidentSummary[]; timeZone: string }) {
  const { t } = useTranslation();
  const days = useMemo(() => buildOutageTrackerDays(incidents, TRACKER_DAYS, timeZone), [incidents, timeZone]);
