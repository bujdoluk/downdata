  ...
  return (
    <div className="flex min-h-full flex-1 flex-col">
      <div className="mx-auto w-full max-w-3xl flex-1 px-6 py-12">
        ...
        <p className="mt-6">
          These terms govern your use of downDATA (&ldquo;the service&rdquo;). By using it, you
          agree to them. If you don&rsquo;t agree, please don&rsquo;t use the service.
        </p>
        ...
        <p>
          Creating an account requires email/password or Google sign-in. You&rsquo;re responsible
        ...
        <p>
          The status and incident data shown for a tracked service is sourced from that
          service&rsquo;s own public Statuspage API, not generated by us. We don&rsquo;t control,
          and aren&rsquo;t responsible for, its accuracy, availability, or timeliness.
        </p>
        ...
        <p>
          ...
          don&rsquo;t guarantee that monitoring or notifications will be uninterrupted, error-free,
          or catch every incident on a tracked service.
        </p>
